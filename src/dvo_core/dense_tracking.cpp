...
void DenseTracker::computeLeastSquaresEquationsForwardAdditive(RgbdImage& ref, RgbdImage& cur, const IntrinsicMatrix& intrinsics, const AffineTransform& transformation, LeastSquaresInterface& ls)
{
...
void DenseTracker::computeLeastSquaresEquationsForwardCompositional(RgbdImage& ref, RgbdImage& cur, const IntrinsicMatrix& intrinsics, const AffineTransform& transformation, LeastSquaresInterface& ls)
{
  RgbdImage cur_warped;
  cv::Mat residuals, cur_dx, cur_dy;
...
void DenseTracker::computeLeastSquaresEquationsForwardCompositionalESM(RgbdImage& ref, RgbdImage& cur, const IntrinsicMatrix& intrinsics, const AffineTransform& transformation, LeastSquaresInterface& ls)
{
...
void DenseTracker::computeLeastSquaresEquationsInverseCompositional(RgbdImage& ref, RgbdImage& cur, const IntrinsicMatrix& intrinsics, const AffineTransform& transformation, LeastSquaresInterface& ls)
{
  RgbdImage cur_warped;
...
struct LeastSquaresEquationsReduction
{
  ...
  const RgbdImage::PointCloud& points;
  const WeightCalculation& weights;
  LeastSquaresEquationsReduction(const cv::Mat& residuals,const WeightCalculation& weights, const cv::Mat& Jix, const cv::Mat& Jiy, const RgbdImage::PointCloud& points) :
    ls(new NormalEquationsLeastSquares()),
    residuals(residuals),
    weights(weights),
    Jix(Jix),
    Jiy(Jiy),
  ...
  void operator()(const tbb::blocked_range<size_t>& r)
  {
    ...
    NormalEquationsLeastSquares* tmp = ls;//new dvo::core::NormalEquationsLeastSquares();
...
inline void DenseTracker::computeLeastSquaresEquationsGeneric(const cv::Mat& residuals, const cv::Mat& Jix, const cv::Mat& Jiy, const RgbdImage::PointCloud& points, LeastSquaresInterface& ls)
{
