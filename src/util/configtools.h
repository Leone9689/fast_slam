...
void updateConfigFromDynamicReconfigure(const fast_slam::CameraDenseTrackerConfig& config, DenseTracker::Config& tracker_cfg)
{
  ScaleEstimators::enum_t scale_estimator;

  switch(config.scale_estimator)
  {
    case fast_slam::CameraDenseTracker_NormalDistributionScaleEstimator:
      scale_estimator = ScaleEstimators::NormalDistribution;
      break;
    case fast_slam::CameraDenseTracker_TDistributionScaleEstimator:
      scale_estimator = ScaleEstimators::TDistribution;
      break;
    case fast_slam::CameraDenseTracker_MADScaleEstimator:
  ...
  {
    case fast_slam::CameraDenseTracker_TukeyInfluenceFunction:
      influence_function = InfluenceFunctions::Tukey;
      break;
    case fast_slam::CameraDenseTracker_TDistributionInfluenceFunction:
      influence_function = InfluenceFunctions::TDistribution;
      break;
    case fast_slam::CameraDenseTracker_HuberInfluenceFunction:
