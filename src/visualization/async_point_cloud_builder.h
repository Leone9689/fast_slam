...
public:
  ...
  public:
    ...
    BuildJob(const RgbdImage& image, const IntrinsicMatrix& intrinsics, const Eigen::Affine3d pose = Eigen::Affine3d::Identity());
  ...
  void build(const RgbdImage& image, const IntrinsicMatrix& intrinsics, const Eigen::Affine3d pose = Eigen::Affine3d::Identity());
