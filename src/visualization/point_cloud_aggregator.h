...
{
public:
  typedef boost::function<AsyncPointCloudBuilder::PointCloud::Ptr()> PointCloudBuilderCallable;

  PointCloudAggregator();
  virtual ~PointCloudAggregator();

  void add(const std::string& name, const AsyncPointCloudBuilder::PointCloud::Ptr& cloud);
